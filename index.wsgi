...
import filters
from helpers import get_headers, status_code, get_dict, check_basic_auth, check_digest_auth, H, ROBOT_TXT, ANGRY_ASCII, ENV_COOKIES
...
def view_origin():
    ...
    return jsonify(get_dict('origin'))
